...
void MAP::generate() {
    ...
    for (int y = 0; y < 64; ++y)
    {
        for (int x = 0; x < 64; ++x)
        {
            ...
            const double metamap = (mperlin.octave2D_01((x * metascalar) + xoff, (y * metascalar) + yoff, 2) * 2 ) -1;
            ...
            const double noise = perlin.octave2D_01((x * scalar) + xoff, (y * scalar) + yoff, 2) + vBias + rnoise + metamap/4;
